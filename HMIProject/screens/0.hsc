...
<ScrInfo ScreenNo="0" ScreenType="" ScreenSize="0">
	<PartInfo PartType="LuaPart" PartName="Lua_0" PartClassifyType="CustomType" PartID="0_Lua_0">
		...
		<LuaScript LuaClickDown="inicializarSistema()" />
